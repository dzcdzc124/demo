...
require.loader = "component", require.helper = {}, require.helper.semVerSort = function(t, e) {
	...
	(function() {
		...
		g.reduce = g.foldl = g.inject = function(t, e, n, r) {
			...
			var r, i, o = t.length !== +t.length && g.keys(t),
				a = (o || t).length;
			for (r = 0; a > r; r++)
				if (i = o ? o[r] : r, !e(t[i], i, t)) return !1;
			return !0
			...
			var r, i, o = t.length !== +t.length && g.keys(t),
				a = (o || t).length;
			for (r = 0; a > r; r++)
				if (i = o ? o[r] : r, e(t[i], i, t)) return !0;
			return !1
		...
		var b = function(t, e, n, r) {
			...
			if ("[object Array]" === i) {
				if (u = t.length, c = u === e.length)
					for (; u-- && (c = b(t[u], e[u], n, r)););
			} else {
				var f, h = g.keys(t);
				if (u = h.length, c = g.keys(e).length === u)
					for (; u-- && (f = h[u], c = g.has(e, f) && b(t[f], e[f], n, r)););
			}
		...
		g.escape = S(E), g.unescape = S(T), g.result = function(t, e) {
		...
		g.template = function(t, e, n) {
			...
			t.replace(r, function(e, n, r, a, s) {
				return o += t.slice(i, s).replace(k, D), i = s + e.length, n ? o += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? o += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : a && (o += "';\n" + a + "\n__p+='"), e
		...
		g.mixin = function(t) {
			g.each(g.functions(t), function(e) {
				...
				g.prototype[e] = function() {
					var t = [this._wrapped];
					return s.apply(t, arguments), C.call(this, n.apply(g, t))
				}
			})
	...
	var n = require("./lib/zepto/touch.js"),
		r = function() {
			...
			function h(t) {
				var e, n;
				return O[t] || (e = C.createElement(t), C.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), O[t] = n), O[t]
			}
			...
			function d(t, e, n) {
				for (E in e) n && (o(e[E]) || $(e[E])) ? (o(e[E]) && !o(t[E]) && (t[E] = {}), $(e[E]) && !$(t[E]) && (t[E] = []), d(t[E], e[E], n)) : e[E] !== b && (t[E] = e[E])
			}
			...
			return X.matches = function(t, e) {
				...
				var r, i = t.parentNode,
					o = !i;
				return o && (i = Y).appendChild(t), r = ~X.qsa(i, e).indexOf(t), o && Y.removeChild(t), r
			}, A = function(t) {
				...
				var r, i, a;
				return L.test(t) && (r = T(C.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(P, "<$1></$2>")), e === b && (e = M.test(t) && RegExp.$1), e in U || (e = "*"), a = U[e], a.innerHTML = "" + t, r = T.each(k.call(a.childNodes), function() {
					a.removeChild(this)
				...
				if (!t) return X.Z();
				if ("string" == typeof t)
					if (t = t.trim(), "<" == t[0] && M.test(t)) r = X.fragment(t, RegExp.$1, n), t = null;
					else {
					...
					else if (M.test(t)) r = X.fragment(t.trim(), RegExp.$1, n), t = null;
					else {
						if (n !== b) return T(n).find(t);
						r = X.qsa(C, t)
					}
				...
				var n, i = "#" == e[0],
					...
					a = i || o ? e.slice(1) : e,
					s = z.test(a);
				return r(t) && s && i ? (n = t.getElementById(a)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : k.call(s && !i ? o ? t.getElementsByClassName(a) : t.getElementsByTagName(e) : t.querySelectorAll(e))
			}, T.contains = C.documentElement.contains ? function(t, e) {
				...
				ready: function(t) {
					return G.test(C.readyState) && C.body ? t(T) : C.addEventListener("DOMContentLoaded", function() {
						t(T)
					}, !1), this
				},
				get: function(t) {
				...
				filter: function(t) {
					return e(t) ? this.not(this.not(t)) : T(D.call(this, function(e) {
				...
				not: function(t) {
					...
					if (e(t) && t.call !== b) this.each(function(e) {
						...
						var r = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? k.call(t) : T(t);
				...
				closest: function(t, e) {
					var n = this[0],
						i = !1;
					for ("object" == typeof t && (i = T(t)); n && !(i ? i.indexOf(n) >= 0 : X.matches(n, t));) n = n !== e && !r(n) && n.parentNode;
					return T(n)
				},
				parents: function(t) {
				...
				siblings: function(t) {
					return g(this.map(function(t, e) {
						return D.call(p(e.parentNode), function(t) {
							return t !== e
						})
					}), t)
				},
				...
				offsetParent: function() {
					return this.map(function() {
						for (var t = this.offsetParent || C.body; t && !I.test(t.nodeName) && "static" == T(t).css("position");) t = t.offsetParent;
						return t
					})
				}
				...
				T.fn[e] = function() {
					...
					return o.length < 1 ? this : this.each(function(t, e) {
						...
						var s = T.contains(C.documentElement, i);
			...
			}), X.Z.prototype = T.fn, X.uniq = j, X.deserializeValue = w, T.zepto = X, T
		}();
	window.Zepto = r, e.exports = void 0 === window.$ && (window.$ = r),
		function(t) {
			function e(t) {
		...
		function(t) {
			...
			A.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
				...
				if (u && u.promise(T), i.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", w || "*/*"), (w = i.mimeType || w) && (w.indexOf(",") > -1 && (w = w.split(",", 2)[0]), T.overrideMimeType && T.overrideMimeType(w)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && b("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)
					for (m in i.headers) b(m, i.headers[m]);
				if (T.setRequestHeader = b, T.onreadystatechange = function() {
						if (4 == T.readyState) {
							...
							if (T.status >= 200 && T.status < 300 || 304 == T.status || 0 == T.status && "file:" == E) {
								...
								try {
									"script" == p ? (1, eval)(e) : "xml" == p ? e = T.responseXML : "json" == p && (e = S.test(e) ? null : t.parseJSON(e))
								} catch (r) {
									n = r
								}
				...
				if (i.xhrFields)
					for (m in i.xhrFields) T[m] = i.xhrFields[m];
				var _ = "async" in i ? i.async : !0;
				T.open(i.type, i.url, _, i.username, i.password);
				for (m in x) j.apply(T, x[m]);
	...
	function n(t) {
		this.config = t, window.WxMoment.projectName = this.config.projectName;
		var e = document.getElementsByTagName("head")[0] || document.documentElement,
			n = document.createElement("script");
		n.async = "true", n.src = window.location.protocol + "//pingjs.qq.com/ping.js";
		var r = !1;
	...
	function n(t) {
		...
		var u = function(t) {
			t = s(t);
			var e = function(e) {
				for (var n = e.resource, r = 1 / 0, i = 0; i < n.tags.length; i++)
					for (var o = 0; o < Math.min(t.length, r) && !(n.tags.all[i] === t[o] && r > o && (r = o, 0 === r)) && 0 !== r; o++);
				return r
			};
			return function(t, n) {
				var r = e(t),
		...
		var l = function(t, e) {
			...
			if (null != h && h.status === a.WAITING)
				for (h.status = e, o = Date.now(), u = t.tags.length, r = 0, s = i.length; s > r; r++) c = i[r], l = 0 === c.tags.length ? !0 : t.tags.intersects(c.tags), l && f(h, c)
		};
	...
	e.exports = function() {
		n("body").append(r), Zepto(function(t) {
			var e = t('meta[name="wxm:link"]').attr("content");
			e || (e = window.location.href), t("#qr-box__img").attr("style", "background-image:url("+window.location.protocol+"//cgi.trade.qq.com/cgi-bin/comm/code/qr.fcg?s=20&m=1&d=" + e + ")");
	...
	require.register("./lib/page-slider", function(t, e) {
	function n(t) {
		if ($.extend(this, l, t), this.pages.length <= 0) throw new Error("target para not pass");
		this.target = this.pages.eq(0).parent(), this.length = this.pages.length, this.moveTo = n.prototype.moveTo, this.index = 0, this.timer = null, ("vertical" === this.direction || "v" === this.direction) && (this.direction = "v"), ("horizontal" === this.direction || "h" === this.direction) && (this.direction = "h"), this.length <= 1 || this._init()
	}
	var r, i, o, a, s, u, c, l = {
			direction: "vertical",
	...
	n.prototype = {
		_init: function() {
			var t = this;
			this.target.css("-webkit-transition", "-webkit-transform 0.5s ease"), this._reset(), this.pages.each(function() {
				var t = $(this),
					e = t.wrapInner('<div class="PageSlider__wraper"></div>').find(".PageSlider__wraper"),
					n = e.height();
				n > h && (t.data("height", n), t.css("overflow", "auto")), e.children().unwrap()
		...
		_startHandle: function(t) {
			...
			if (s = "v" === this.direction ? e.clientY : e.clientX, r = this.pages.eq(this.index), i = r.data("lock-next"), o = r.data("lock-prev"), r[0].pageScrollHeight = r.data("height"), r[0].pageScrollHeight && (this.preventDefault = !1, c = h + r.scrollTop()), this.gestureFollowing) {
		...
		_endHandle: function(t) {
			...
			if (n = "v" === this.direction ? u.clientY : u.clientX, e = n - s, this._setTransition(), e > 0 && ("v" === this.direction ? this.onSwipeDown.call(this) : this.onSwipeRight.call(this), !o)) {
				if (r[0].pageScrollHeight && c > h) return;
		...
		moveTo: function(t, e) {
			...
			a = "running", e = e || !1;
			var o, s;
			return Math.abs(t - this.index) > 1 ? o = "pageSliderMoveWxm" : t - this.index > 0 ? o = "pageSliderDownWxm" : t - this.index < 0 && (o = "pageSliderUpWxm"), s = t >= this.length ? "bottom" : 0 > t ? "top" : this.index + "to" + t, this._sendEvent(o, s), t >= this.length || 0 > t ? void(a = "end") : (e && this._removeTransition(), this.onbeforechange.call(this), "v" === this.direction && (n = -t * h + "px", this.target.css("-webkit-transform", "translate(0, " + n + ")")), "h" === this.direction && (n = -t * f + "px", this.target.css("-webkit-transform", "translate(" + n + ", 0)")), clearTimeout(this.timer), void(this.timer = setTimeout(function() {
				i._currentClass(t), i.prevIndex = i.index, i.index = t, i.onchange.call(i), e && i._setTransition(), r && r[0].pageScrollHeight && (i.preventDefault = !0, r.scrollTop(0)), i.rememberLastVisited && i._saveLastVisited(), a = "end", clearTimeout(this.timer)
			}, 500)))
		},
		prev: function() {
		...
		_sendEvent: function(t, e) {
			"function" == typeof pgvSendClick && t && e && window.WxMoment.projectName && pgvSendClick({
				hottag: "WXM." + window.WxMoment.projectName + "." + t + "." + e
			})
		},
		...
		_currentClass: function(t) {
			...
			this.pages.eq(t).addClass(e), t === this.index || this.animationPlayOnce || this.pages.eq(this.index).removeClass(e)
		},
		_reset: function() {
			var t = this.direction;
			f = document.documentElement.clientWidth, h = document.documentElement.clientHeight, this.pages.each(function() {
				var t = $(this);
				t.width(f + "px"), t.height(h + "px")
			}), "v" === t && (this.target.width(f + "px"), this.target.height(h * this.length + "px")), "h" === t && (this.target.width(f * this.length + "px"), this.target.height(h + "px"))
		},
		_createDot: function() {
			for (var t = "", e = 0; e < this.length; e++) t += "<li>" + (e + 1) + "</li>";
		...
		_bindAnimation: function() {
			...
			$("[data-animation]").each(function(n) {
				...
				r.data("animationid", ++n), e += "." + t.currentClass + ' [data-animationid="' + n + '"]{-webkit-animation-name: ' + o + ";-webkit-animation-duration: " + a + "ms;-webkit-animation-delay: " + s + "ms;-webkit-animation-timing-function: " + u + ";-webkit-animation-fill-mode: " + c + ";-webkit-animation-iteration-count: " + l + ";}"
			}), $("head").eq(0).append(e)
		},
	...
	n.prototype.init = function(t) {
		...
		}, this.config = o.extend({}, t, this.config), this.config.timeline = o.extend({}, this.config.global, this.config.timeline), this.config.appmessage = o.extend({}, this.config.global, this.config.appmessage);
		var e = this,
			n = function() {
				WeixinJSBridge.on("menu:share:appmessage", function() {
					WeixinJSBridge.invoke("sendAppMessage", e.config.appmessage, function(t) {
						"send_app_msg:cancel" !== t.err_msg && o.isFunction(e.config.appmessage.success) ? (e.config.appmessage.success(), i("shareAppmessageWxm", "success")) : o.isFunction(e.config.appmessage.cancel) && (e.config.appmessage.cancel(), i("shareAppmessageWxm", "cancel"))
					})
				}), WeixinJSBridge.on("menu:share:timeline", function() {
					WeixinJSBridge.invoke("shareTimeline", e.config.timeline, function(t) {
						"share_timeline:cancel" !== t.err_msg && o.isFunction(e.config.timeline.success) ? (e.config.timeline.success(), i("shareTimelineWxm", "success")) : o.isFunction(__this._this.config.timeline.cancel) && (e.config.timeline.cancel(), i("shareTimelineWxm", "cancel"))
					})
				})
			};
		...
		3 === arguments.length && o.isString(arguments[0]) && o.isString(arguments[1]) ? this.config[arguments[0]][arguments[1]] = arguments[2] : console.log("[WxMoment Share] set 函数参数错误")
	}, e.exports = n
}), require.register("./lib/video", function(t, e) {
	function n(t) {
		"function" == typeof pgvSendClick && t && window.WxMoment.projectName && pgvSendClick({
			hottag: "WXM." + window.WxMoment.projectName + ".videoWxm." + t
		})
	}
	...
	function r(t, e) {
		return u = c.extend({
			...
			autoplay: !1
		}, t), u.oninited = function() {
			n("oninited"), "function" === typeof t.oninited && t.oninited()
		}, u.onplaying = function() {
			n("onplaying"), "function" === typeof t.onplaying && t.onplaying()
		}, u.onpause = function() {
			n("onpause"), "function" === typeof t.onpause && t.onpause()
		}, u.onresume = function() {
			n("onresume"), "function" === typeof t.onresume && t.onresume()
		}, u.onallended = function() {
			n("onallended"), "function" === typeof t.onallended && t.onallended()
		}, u.onfullscreen = function(e) {
			n("onfullscreen"), "function" === typeof t.onfullscreen && t.onfullscreen(e)
		}, u.vid ? (i(), s) : void console.log("请设置视频 vid")
	}

	function i() {
		var t = document.getElementsByTagName("head")[0] || document.documentElement,
			e = document.createElement("script");
		e.async = "true", e.src = window.location.protocol + "//imgcache.gtimg.cn/tencentvideo_v1/tvp/js/tvp.player_v2_zepto.js";
		var n = !1;
	...
	function o() {
		a = new tvp.VideoInfo, s = new tvp.Player, a.setVid(u.vid), u.video = a, s.create(u)
	}
	var a, s, u, c = require("./lib/underscore");
	...
	var n = require("./lib/underscore"),
		...
		u = require("./lib/video"),
		c = function(t) {
			this.version = "0.0.3", this.options = {}, this.options = n.extend(this.options, t), this.Loader = i, this.Analytics = r, this.PageSlider = a, this.Share = s, this.OrientationTip = o, this.Video = u
		};
